...
The name of the extension to publish.
...
param(
  ...
  [string]$ExtensionName = "Bicep.Extension",
...
PROCESS {
  ...
  D:\bicep-install\bicep.exe publish-extension --bin-osx-arm64 $root/bin/release/net9.0/osx-arm64/publish/$ExtensionName `
